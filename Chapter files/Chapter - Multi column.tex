\section{Multicolumn Layout Chapter}
% \hyphenpenalty=500 % Can be used to help with the "Underfull \hbox" warning
% \tolerance=7000    % Can be used to help with the "Underfull \hbox" warning
% The best fix however is to include the "\usepackage{microtype}" pagage
\begin{multicols}{2}
